...
async function obtenerValor(value) {
    ...
    switch (valorSeleccionado) {
        case "pay_ven":
            //paypal
            var selectPaypal = document.getElementById("paisesPaypal");
            var indicePaypal = selectPaypal.selectedIndex;
            var textoPaypal = selectPaypal.options[indicePaypal].textContent;
            $("#monto_pagar_pay_ven").html(("$" + (parseFloat((calculo.data.comision_clear).replace(",", ".")) + parseFloat(calculo.data.pagar_clear)).toLocaleString()) + " dólar");
            $("#monto_recibir_pay_ven").val(calculo.data.recibir);
            $("#monto_recibir_comision_pay_ven").html(calculo.data.comision);
            $("#tipo_cambio_paypal").html(calculo.data.tasa.valor + textoPaypal);
            break;
        case "usd_ven":
            //usdt
            var selectUsdt = document.getElementById("paisesUsdt");
            var indiceUsdt = selectUsdt.selectedIndex;
            var textoUsdt = selectUsdt.options[indiceUsdt].textContent;
            $("monto_pagar_usd_ven").html(("$" + (parseFloat((calculo.data.comision_clear).replace(",", ".")) + parseFloat(calculo.data.pagar_clear)).toLocaleString()) + " usd");
            $("monto_recibir_usdt_ven").val(calculo.data.recibir);
            $("monto_recibir_comision_usd_ven").html(calculo.data.comision);
            $("tipo_cambio_usdt").html(calculo.data.tasa.valor + textoUsdt);
            break;
        case "zinli_ven":
            //zinli
            var selectZinli = document.getElementById("paisesZinli");
            var indiceZinli = selectZinli.selectedIndex;
            var textoZinli = selectZinli.options[indiceZinli].textContent;
            $("monto_pagar_zinli_ven").html(("$" + (parseFloat((calculo.data.comision_clear).replace(",", ".")) + parseFloat(calculo.data.pagar_clear)).toLocaleString()) + " usd");
            $("monto_recibir_zinli_ven").val(calculo.data.recibir);
            $("monto_recibir_comision_zinli_ven").html(calculo.data.comision);
            $("tipo_cambio_zinli").html(calculo.data.tasa.valor + textoZinli);
            break;
        case "peru_ven":
            //peru
