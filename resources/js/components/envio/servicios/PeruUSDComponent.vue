...
export default {
    ...
    computed: {},
    created() {
        this.initServicePeruUSD();
        this.initServicePeruUSDDepositante();
    },
    watch: {
    ...
    mounted() {},
    methods: {
        async initServicePeruUSD() {
            this.beneficiarios = await this.getTerceros("TB", "TP-05");
            this.depositantes = await this.getTerceros("TD", "TP-05");
        ...
        async initServicePeruUSDDepositante() {
            // moneda Peru USD
            this.optionsBancosPeru = await this.$getBancoByMoneda(3);
            this.optionsDocumentDepositantePeru = await this.$getTDByMoneda(3);
        },
        ...
        async initBeneficiario() {
            ...
            this.beneficiarioForm.servicio = "TP-05";
        ...
        async initDepositante() {
            ...
            this.depositanteForm.servicio = "TP-05";
