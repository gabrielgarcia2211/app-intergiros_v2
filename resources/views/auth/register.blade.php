    ...
    <div class="container login">
        ...
        <form action="" id="formVerificacion">
            <div id="div4" style="display: none;">
                ...
                <div class="form-row mt-5">
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <select class="form-control input-indicativo" name="tipoDocumento"
                                        id="tipoDocumento">
                                    </select>
                                </div>
                                <input type="number" class="form-control input-telefono" name="documento"
                                    id="documento" placeholder="Número documento">
                            </div>
                        </div>
                        <div class="mt-3">
                            <div class="form-group">
                ...
                <div class="text-center">
                    <a href="#" class="atras" data-toggle="modal" data-target="#myModal"
                        onclick="omitirDiv5()">Omitir por ahora</a>
                </div>
            </div>
        </form>
        <!-- DIV BIENVENIDA -->
