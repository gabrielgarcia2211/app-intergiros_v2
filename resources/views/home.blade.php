        ...
        <div class="row">
            ...
            <div class="col-md-7 data">
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-6 text-right">
                        <h4><span id="monto_recibir_comision_col_ven">0.00</span></h4>
                        <h4><span id="monto_pagar_col_ven" style="display: inline-block">0.00</span></h4>
                        <h4><span id="tipo_cambio_colombia">0.00</span></h4>
                    </div>
                </div>
                <div class="mt-5">
                    <h4>No cobramos comisión por envíos. IMPORTANTE, en caso de que el banco realice algún cobro de comisión
