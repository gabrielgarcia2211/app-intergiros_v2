...
<div class="container cambios" style="display: none;" id="usd_ven">
    <div class="row">
        ...
        <div class="col-md-7 data">
            <div class="form-group">
                <input type="number" class="form-control w-100%" id="monto_cambiar_usd_ven" placeholder="Monto a enviar"
                    onkeyup="obtenerValor(this.value)">
            </div>
            <div class="text-center">
                <img src="{{ asset('img/home/Ícono para la calculadora.png') }}" class="img-fluid" alt="">
            ...
            <div class="form-group mt-4">
                <input type="text" class="form-control w-100%" id="monto_recibir_usd_ven" placeholder="Monto a recibir"
                    readonly>
            </div>
            <div class="row mt-4">
                <div class="col-6">
...
<div class="container cambios" style="display: none;" id="peru_ven">
    <div class="row">
        ...
        <div class="col-md-7 data">
            ...
            <div class="form-group mt-4">
                <input type="text" class="form-control w-100%" id="monto_recibir_peru_ven" placeholder="Monto a recibir"
                    readonly>
            </div>
            <div class="row mt-4">
                <div class="col-6">
...
<div class="container cambios" style="display: none;" id="col_ven">
    <div class="row">
        ...
        <div class="col-md-7 data">
            <div class="form-group">
                <input type="number" class="form-control w-100%" id="monto_cambiar_col_ven" placeholder="Monto a enviar"
                    onkeyup="obtenerValor(this.value)">
            </div>
            <div class="text-center">
                <img src="{{ asset('img/home/Ícono para la calculadora.png') }}" class="img-fluid" alt="">
            ...
            <div class="form-group mt-4">
                <input type="text" class="form-control w-100%" id="monto_recibir_col_ven" placeholder="Monto a recibir"
                    readonly>
            </div>
            <div class="row mt-4">
                <div class="col-6">
