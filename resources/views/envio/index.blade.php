                        ...
                        <div class="row">
                            <div class="col-6">
                                <button type="button" class="btn btn-primary" id="editDepositante"
                                    onclick="activarEditDepositante()">Editar</button>
                                <button type="button" class="btn btn-primary" id="guardarEdit1"
                                    onclick="setDepositante()" disable>Guardar Edicion</button>
                            </div>
                            <div class="col-6">
                                <button type="button" class="btn btn-primary" onclick="deleteDepositante()"> <i
                                        class="fas fa-trash-alt"></i></button>
                            </div>
                        </div>
                    </div>
