...
<div class="container mt-5" id="panel-envios" style="display: none;">
    ...
    <div class="row mt-5">
        ...
        <div class="col-md-6">
            ...
            <div class="text-center">
                <p onclick="activarBeneficiario()" style="color: #0035aa; cursor: pointer; text-decoration: underline;">
        ...
        <div class="col-md-6">
            ...
            <div class="text-center">
                <p onclick="activarDepositante()" style="color: #0035aa; cursor: pointer; text-decoration: underline;">
                    <i class="fas fa-plus"></i>
                    Afiliar nuevo depositante
                </p>
            </div>
            <form action="" id="formPaytoBolivares">
                <div class="text-center mt-4" style="display: none;" id="depositante">
                    <div class="form-group">
                        <input type="text" class="form-control input-registro miInput2" id="paypalAliasDepositante"
                            name="paypalAliasDepositante" placeholder="Alias">
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control input-registro miInput2" id="paypalNombreDepositante"
                            name="paypalNombreDepositante" placeholder="Nombres y apellidos">
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            <div class="input-group-prepend">
                    ...
                    <div class="form-group">
                        <input type="email" class="form-control input-registro miInput2" id="paypalCorreoDepositante"
                            name="paypalCorreoDepositante" placeholder="Correo PayPal de pago">
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            <div class="input-group-prepend">
                    ...
                    <div class="text-center mt-3">
                        <div class="text-center" style="display: flex; justify-content: center;">
                            <button type="button" class="btn btn-primary" onclick="addDepositante()" id="cuentaNueva2"
                                style="display: none;background-color: transparent; border: none; color: #0035aa;">Guardar</button>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <button type="button" class="btn btn-primary" id="guardarEdit2"
                                        onclick="setDepositante()"
                                        style="display: none;background-color: transparent; border: none; color: #0035aa; margin-left: 22%;">Guardar
                                        Edicion</button>
                                </div>
                                <div class="col-6">
                                    <button type="button" class="btn btn-primary" onclick="deleteDepositante()"
                                        style="background-color: transparent; border: none; color: #0035aa;"> <i
                                            class="fas fa-trash-alt"></i></button>
                                </div>
                            </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="text-center mt-4">
                <div class="form-group">
                    <input type="number" class="form-control input-registro" id="nombre" placeholder="Monto a cambiar">
                    <div class="mt-2">
        ...
        <div class="col-md-6">
            <div class="text-center mt-4">
                <button class="btn btn-primary" type="button" id="realizarPago" style="width: 80%;" disabled>Realizar
                    pago</button>
            </div>
        </div>
    </div>
    ...
    <div class="text-center mt-5">
        <button class="btn btn-primary" type="button" id="tasas-venezuela" style="width: 25%;" disabled>Enviar</button>
    </div>
</div>
<br><br><br><br><br>
