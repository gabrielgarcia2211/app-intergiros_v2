            ...
            <div class="seccion mt-5">
                <div>
                    <div class="container">
                        ...
                        <div class="text-center">
                            <a href="#proceso1" data-toggle="collapse" style="color: #818181;">
                                <i class="fas fa-chevron-down" id="iconoProceso1"></i>
                            </a>
                        </div>
                    </div>
                    <div id="proceso1" class="collapse container">
                        <div class="text-center">
                ...
                <div>
                    <div class="container">
                        ...
                        <div class="text-center">
                            <a href="#proceso2" data-toggle="collapse" style="color: #818181;">
                                <i class="fas fa-chevron-down" id="iconoProceso2"></i>
                            </a>
                        </div>
                    </div>
                    <div id="proceso2" class="collapse container">
                        <div class="text-center">
                            <p><strong>Su solicitud ha sido rechazada debido a que el pago realizado no figura en nuestra
                                    cuenta.</strong></p>
                        </div>
            ...
            <div class="seccion mt-5">
                <div>
                    <div class="container">
                        ...
                        <div class="text-center">
                            <a href="#solucionar1" data-toggle="collapse" style="color: #818181;">
                                <i class="fas fa-chevron-down" id="iconoSolucionar1"></i>
                            </a>
                        </div>
                    </div>
                    <div id="solucionar1" class="collapse container">
                        <div class="text-center">
                            <p><strong>Su solicitud ha sido rechazada debido a que el pago realizado no figura en nuestra
                                    cuenta.</strong></p>
                        </div>
                ...
                <div>
                    <div class="container">
                        ...
                        <div class="text-center">
                            <a href="#solucionar2" data-toggle="collapse" style="color: #818181;">
                                <i class="fas fa-chevron-down" id="iconoSolucionar2"></i>
                            </a>
                        </div>
                    </div>
                    <div id="solucionar2" class="collapse container">
                        <div class="text-center">
                            <p><strong>Su solicitud ha sido rechazada debido a que el pago realizado no figura en nuestra
                                    cuenta.</strong></p>
                        </div>
            ...
            <div class="seccion mt-5">
                <div>
                    <div class="container">
                        ...
                        <div class="text-center">
                            <a href="#procesados1" data-toggle="collapse" style="color: #818181;">
                                <i class="fas fa-chevron-down" id="iconoProcesado1"></i>
                            </a>
                        </div>
                    </div>
                    <div id="procesados1" class="collapse container">
                        <div class="text-center">
                            <p><strong>Su solicitud ha sido rechazada debido a que el pago realizado no figura en nuestra
                                    cuenta.</strong></p>
                        </div>
                ...
                <div>
                    <div class="container">
                        ...
                        <div class="text-center">
                            <a href="#procesados2" data-toggle="collapse" style="color: #818181;">
                                <i class="fas fa-chevron-down" id="iconoProcesado2"></i>
                            </a>
                        </div>
                    </div>
                    <div id="procesados2" class="collapse container">
                        <div class="text-center">
                            <p><strong>Su solicitud ha sido rechazada debido a que el pago realizado no figura en nuestra
                                    cuenta.</strong></p>
                        </div>
            ...
            <div class="seccion mt-5">
                <div>
                    <div class="container">
                        ...
                        <div class="text-center">
                            <a href="#rechazados1" data-toggle="collapse" style="color: #818181;">
                                <i class="fas fa-chevron-down" id="iconoRechazado1"></i>
                            </a>
                        </div>
                    </div>
                    <div id="rechazados1" class="collapse container">
                        <div class="text-center">
                            <p><strong>Su solicitud ha sido rechazada debido a que el pago realizado no figura en nuestra
                                    cuenta.</strong></p>
                        </div>
                ...
                <div>
                    <div class="container">
                        ...
                        <div class="text-center">
                            <a href="#rechazados2" data-toggle="collapse" style="color: #818181;">
                                <i class="fas fa-chevron-down" id="iconoRechazado2"></i>
                            </a>
                        </div>
                    </div>
                    <div id="rechazados2" class="collapse container">
                        <div class="text-center">
                            <p><strong>Su solicitud ha sido rechazada debido a que el pago realizado no figura en nuestra
                                    cuenta.</strong></p>
                        </div>
