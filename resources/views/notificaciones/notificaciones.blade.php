        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active w-100" id="opcion1-tab" data-toggle="tab" href="#opcion1" role="tab"
                    aria-controls="opcion1" aria-selected="true" style="color: #0035aa !important;">Solicitudes<span class="notification-badge"></span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link w-100" id="opcion2-tab" data-toggle="tab" href="#opcion2" role="tab"
                    aria-controls="opcion2" aria-selected="false" style="color: #0035aa !important;">Noticias<span class="notification-badge"></span></a>
            </li>
            <li class="nav-item">
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade" id="opcion3" role="tabpanel" aria-labelledby="opcion3-tab">
                <div class="d-flex align-items-center justify-content-center mt-4">
                    <img src="{{ asset('img/notificaciones/Sin mensajes.png') }}" class="img-fluid" alt="" width="400px">
                </div>
            </div>
        </div>
    </div>
